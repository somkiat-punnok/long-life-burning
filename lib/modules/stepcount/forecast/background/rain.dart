...
class _RainState extends State<Rain> {
  ...
  Future<Null> _loadAssets(AssetBundle bundle) async {
    ...
    String json = await DefaultAssetBundle.of(context).loadString('assets/jsons/weathersprites.json');
    _sprites = SpriteSheet(_images['assets/images/weathersprites.png'], json);
  }
