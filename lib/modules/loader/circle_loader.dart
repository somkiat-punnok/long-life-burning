...
class _CircleLoaderState extends State<CircleLoader> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    controller1 = AnimationController(duration: Duration(milliseconds: 1200), vsync: this);
    controller2 = AnimationController(duration: Duration(milliseconds: 900), vsync: this);
    controller3 = AnimationController(duration: Duration(milliseconds: 2000), vsync: this);
